...
# NPC Name Generator:
# a generator that creates npc with Race, hair, build, eye, age, gender, name

# NOTE: will make so npc are more/less likely to have grey/white hair if older/younger
# NOTE: will make so npc of different races actually have proper age ranges for that race
...
def save_all_race_names_to_text():
    ...
    for race in race_list:
        ...
        for gender in genders:
            ...
            filename = "npc_generator/%s_%s_names.txt" % (gender, race)
...
def save_all_lastnames_to_text():
    ...
    for race in race_list:
        ...
        for prefix in last_name_prefixes:
            _data = _data + prefix + "\n"
        filename = "npc_generator/%s_prefixes.txt" % (race)
        save(filename, _data)
        _data = ""
        ...
        for suffix in last_name_suffixes:
            _data = _data + suffix + "\n"
        filename = "npc_generator/%s_suffixes.txt" % (race)
        save(filename, _data)
        _data = ""
...
def save_all_hair_info_to_text():
    ...
    for race in race_list:
        ...
        filename = "npc_generator/%s_hair_colours.txt" % (race)
        save(filename, _data)
        _data = ""

    for hair_length in hair_len:
        _data = _data + hair_length + "\n"
        filename = "npc/npc_generator/hair_lengths.txt"
        save(filename, _data)
        _data = ""

    for description in hair_descriptions:
        _data = _data + description + "\n"
        filename = "npc/npc_generator/hair_descriptions.txt"
        save(filename, _data)
        _data = ""
...
def save_all_size_info_to_text():
    ...
    for race in race_list:
        ...
        for build in race_builds:
            _data = _data + build + "\n"
        filename = "npc_generator/%s_race_builds.txt" % (race)
        save(filename, _data)
        _data = ""
...
def save_all_eye_descriptions():
    ...
    filename = "npc_generator/eye_descriptions.txt"
    save(filename, _data)
    _data = ""
...
def save_all_eye_colours():
    ...
    filename = "npc_generator/eye_colours.txt"
    save(filename, _data)
    _data = ""
...
def save_all_age_ranges():
    ...
    for race in race_list:
        ...
        for age_range in age_ranges[race]:
            ...
            _data = _data + _str
        filename = "npc_generator/%s_age_ranges.txt" % (race)
        save(filename, _data)
        _data = ""
