...
from npc_commands import npc_registry, NPCCommands
from combat_commands import CombatCommands
from dm_commands import DMCommands
from scene_commands import scene_registry, scene_descriptions, scene_backgrounds, scene_maps, SceneCommands
...
async def test_inventory_commands(dm):
    ...
    chan = DummyChannel()
    author = DummyAuthor('TestUser', '0001')
    character = Character.from_json('characters/rynn_dragonwhisper.json')
