HELP_LOGIN_MESSAGE = """Wondering how to 'login'? Type !help followed by your character's first name.\n
...
!login <character> — Log in as your character.
!logout — Log out and save.
!whoami - Quick self check.
!profile - Show your profile.
!whois - Queries other characters.
!status — View your current character’s health status.
...
Update Notes:
Wow hey so I just added AI to the system! It should make it a lot more useable...
